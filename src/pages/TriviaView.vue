<template>
  <div class="row orientation-landscape">
    <div class="bg-question row animate__animated animate__fadeIn " style="height: 100vh;" v-if="!showAnwserResult">
      <div class="col-3 self-center" >
        <div class="row justify-center ">
          <q-circular-progress
            ...
            :thickness="1"
            color="portugues"
            class="text-titulos itau-font-bd "
            font-size="5rem"
            size="150px"
            track-color="espanol"
          />
      ...
      <div class="col-9 self-center q-pr-xl " style="padding-right: 10em;" >
        <div class="row ">
          <div class="text-h2 text-left q-mb-xl text-white itau-font-blk">{{randomQuestion[currentQuestion].pregunta}}</div>
        </div>
    ...
    <div class="bg-answer col flex flex-center" style="height: 100vh;" v-else>
  ...
  <!-- <div class="row orientation-portrait"> -->
    <div class="bg-question-vert row animate__animated animate__fadeIn orientation-portrait" style="height: 100vh;" v-if="!showAnwserResult">
      <div class="col-12 self-center q-pb-xl" >
        <div class="row justify-center ">
          <q-circular-progress
            :value="countDown"
            :show-value="true"
      ...
      <div class="col-12 q-px-lg" >
        <div class="row ">
          <div class="text-h2 text-center q-mb-md q-px-xl itau-font-blk">{{randomQuestion[currentQuestion].pregunta}}</div>
        </div>
        <div class="row q-col-gutter-md q-mt-sm q-px-xl text-center">
          <div class="col-12 itau-font-rg" :key="index" v-for="(option, index) in randomQuestion[currentQuestion].answerOptions">
            <q-btn
              @click="handleAnswerClick(option.isCorrect)"
              rounded
    ...
    <div class="bg-answer-vert flex flex-center" style="height: 100vh;" v-else>
      <div class="row justify-center" v-if="showCorrect">
        <h1 class="itau-font-blk q-pb-xl col-12 text-center">{{$t('msg_correct')}}</h1>
        <img
          alt="Quasar logo"
          src="~assets/contento.svg"
          style="width: 150px; height: 150px"
